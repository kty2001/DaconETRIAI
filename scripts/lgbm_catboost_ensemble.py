...
출력: submission/lgbm_catboost_ensemble_prob.csv (clip 0.1~0.9)
"""
...
def main():
    ...
    print(f"=== LGBM + CatBoost 앙상블 (각 {N_TRIALS} trials, 피처 {feat_count}개) ===\n")
    ...
    out_path = SUBMISSION_DIR / "lgbm_catboost_ensemble_prob.csv"
